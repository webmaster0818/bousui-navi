  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第1条（サービスの概要）</h2>
          <p>
            ベランダ防水ナビ（以下「本サービス」）は、ベランダ・屋上の防水工事に関する情報提供を目的として運営されるメディアサービスです。
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第2条（禁止事項）</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第3条（免責事項）</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第4条（アフィリエイト広告について）</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第5条（知的財産権）</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第6条（リンクについて）</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第7条（規約の変更）</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">第8条（準拠法・管轄裁判所）</h2>
          <p>
