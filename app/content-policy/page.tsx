  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 space-y-8 text-gray-700 leading-relaxed">
        ...
        <p>
          ベランダ防水ナビは、ベランダ・屋上の防水工事を検討するユーザーに対して、
          正確で有益な情報をお届けすることを使命としています。
          以下の編集方針に基づいてコンテンツを制作しています。
        </p>

        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">編集方針</h2>
          <p className="mb-3">
            当サービスの記事は、防水工事・建築リフォームに関する専門知識を持つ編集スタッフが制作・監修しています。
            ユーザーが防水工事を検討する際に本当に必要な情報を、
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">情報の正確性について</h2>
          <p className="mb-3">
            掲載する費用相場・業者情報・工法情報については、以下のプロセスで正確性を確認しています。
          </p>
          <ul className="list-disc list-inside space-y-2 pl-2">
            <li>複数の防水工事業者への取材・ヒアリングに基づく情報収集</li>
            <li>公的機関・業界団体の統計データの参照</li>
            <li>掲載前の編集チームによるファクトチェック</li>
            <li>定期的な情報の見直しと更新</li>
          </ul>
          <p className="mt-3 text-sm text-gray-500">
            ※費用相場は地域・業者・建物の状況によって大きく変動します。掲載情報はあくまで参考値としてご活用ください。
          </p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">広告・アフィリエイトとの関係</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">更新頻度・情報鮮度</h2>
          <p className="mb-3">
            防水工事業界の情報・価格相場は変動します。当サービスでは以下の基準で情報を更新しています。
          </p>
          <ul className="list-disc list-inside space-y-2 pl-2">
            <li>業者ランキング・評価: 半年ごとに見直し</li>
            <li>費用相場情報: 年1回以上の更新</li>
            <li>法令・補助金制度関連情報: 改正時に随時更新</li>
            <li>読者からの指摘・誤情報の報告: 迅速に対応</li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">引用元・参考資料の明示</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">お問い合わせ・誤情報の報告</h2>
          <p>
