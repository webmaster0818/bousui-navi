  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 space-y-8 text-gray-700 leading-relaxed">
        ...
        <p>
          株式会社MediaX（以下「当社」）は、ベランダ防水ナビ（以下「本サービス」）における
          ユーザーの個人情報の取り扱いについて、以下のとおりプライバシーポリシーを定めます。
        </p>

        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">Cookieの使用について</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">Google Analyticsの使用について</h2>
          <p className="mb-3">
          ...
          <p>
            ...
            <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[#2563EB] hover:underline ml-1">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">アフィリエイトプログラムについて</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">個人情報の管理</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-blue-100">プライバシーポリシーの変更</h2>
          <p>
